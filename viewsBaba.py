...
from .forms import IndividuForm, DiplomeForm, CandidatForm
from datetime import datetime
from .models import Individu, Test, Diplome, Candidat, These, Equipe_recherche, Professeur, Doctorant, Jury, Enregistrement, Article
...
def selectionView(request):
    ...
    return render(request, "general/candidatList.html", {'individus': individus})
