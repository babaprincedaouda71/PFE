...
class nationalite(models.Model):
    code_nat = models.AutoField(primary_key = True)
    libelle_nat = models.CharField(max_length = 30)
    cin = models.ForeignKey(individu, on_delete = models.CASCADE)

class posseder_nat(models.Model):
    code_nat = models.ForeignKey(nationalite, on_delete = models.CASCADE)
    cin = models.ForeignKey(individu, on_delete = models.CASCADE)
...
class candidat(models.Model):
    ...
    cine = models.ForeignKey(individu, on_delete = models.CASCADE, default = "")
    def __str__(self):
