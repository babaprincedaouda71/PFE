...
from .models import individu,diplome,candidat,these,compte,doctorant,professeur,equipe_recherche,labo,enregistrement,posseder_dip,jury,admini,test,profile
...
admin.site.register(equipe_recherche)
